...
let threeOptions = ['Put Hand in Hole','Find the Key','Open the Door'],
...
while (isAlive){ 
        ...
        if (threeOptions[index] === 'Put Hand in Hole') {
            ...
            console.log("Yay you found the key. You can go now")
            isAlive = false
            return
                
        }
        else if(threeOptions[index] === 'Open the Door') {
            console.log("You cannot open the door without finding the key first. Please choose another option.");
